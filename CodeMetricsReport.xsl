	...
	<xsl:template match="/">
		<html>
			...
			<body>
				...
				<div id="NORM"><h2>NORM(Number of Overridden Methods) -- greater than 3</h2></div>
				<table border="1">
					<tr bgcolor="#9acd32">
						<td>ClassName</td>
						<td>Number</td>
				...
				<div id="NOF"><h2>NOF(Number of Attributes) -- greater than 5</h2></div>
				<table border="1">
					<tr bgcolor="#9acd32">
						<td>ClassName</td>
						<td>Number</td>
				...
				<div id="NSC"><h2>NSC(Number of Children) -- greater than 3</h2></div>
				<table border="1">
					<tr bgcolor="#9acd32">
						<td>ClassName</td>
						<td>Number</td>
				...
				<div id="MLOC"><h2>MLOC(Method Lines of Code) -- greater than 50</h2></div>
				<table border="1">
					<tr bgcolor="#9acd32">
						<td>ClassName</td>
						<td>MethodName</td>
				...
				<div id="NOM"><h2>NOM(Number of Methods) -- greater than 15</h2></div>
				<table border="1">
					<tr bgcolor="#9acd32">
						<td>ClassName</td>
						<td>Number</td>
				...
				<div id="NBD"><h2>NBD(Nested Block Depth) -- greater than 4</h2></div>
				<table border="1">
					<tr bgcolor="#9acd32">
						<td>ClassName</td>
						<td>MethodName</td>
				...
				<div id="DIT"><h2>DIT(Depth of Inheritance Tree) -- greater than 3</h2></div>
				<table border="1">
					<tr bgcolor="#9acd32">
						<td>ClassName</td>
						<td>Number</td>
				...
				<div id="VG"><h2>VG(McCabe Cyclomatic Complexity) -- greater than 15</h2></div>
				<table border="1">
					<tr bgcolor="#9acd32">
						<td>ClassName</td>
						<td>MethodName</td>
				...
				<div id="PAR"><h2>PAR(Number of Parameters) -- greater than 5</h2></div>
				<table border="1">
					<tr bgcolor="#9acd32">
						<td>ClassName</td>
						<td>MethodName</td>
				...
				<div id="LCOM"><h2>LCOM(Lack of Cohesion of Methods) -- greater than 0.8</h2></div>
				<table border="1">
					<tr bgcolor="#9acd32">
						<td>ClassName</td>
						<td>Ratio</td>
				...
				<div id="NSM"><h2>NSM(Number of Static Methods) -- greater than 5</h2></div>
				<table border="1">
					<tr bgcolor="#9acd32">
						<td>ClassName</td>
						<td>Number</td>
				...
				<div id="WMC"><h2>WMC(Weighted methods per Class) -- greater than 100</h2></div>
				<table border="1">
					<tr bgcolor="#9acd32">
						<td>ClassName</td>
						<td>Weight</td>
				...
				<div id="NSF"><h2>NSF(Number of Static Attributes) -- greater than 5</h2></div>
				<table border="1">
					<tr bgcolor="#9acd32">
						<td>ClassName</td>
						<td>Number</td>
